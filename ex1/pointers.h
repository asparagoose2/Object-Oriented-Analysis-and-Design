...
public:
	...
	UniquePointer(/*Add your code*/) //Create move semantics for rvalue referance
	{
		/*Add your code*/
	}
...
template </*Add your code*/ >
class SharedPointer
{
public:
	SharedPointer(T* p) : _ptr(p), _counter(/*Add your code*/) {}
